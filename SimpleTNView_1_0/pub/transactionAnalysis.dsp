<html>
	...
	<head>
		<title>TN document search</title>
...
function clearForm()
{
	...
	<body >
		<table width=100% >
			<tr>
				<td class="heading" colspan="2">TN Data Search
				</td>
			</tr>
			<tr>
				<td class="menusection-Logs" colspan=2>TN Document Search&nbsp;</td>
			</tr>

<td class="evenrow-l"><a href="archive_transactionAnalysis.dsp">Archive Data Search</a> &nbsp;</td><td></td>
...
<input type="button" value="clear" name="clear" onclick="clearForm();" target="main"></td>

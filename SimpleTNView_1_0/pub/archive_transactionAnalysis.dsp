<html>
	...
	<head>
		<title>TN archive document search</title>
...
function clearForm()
{
	...
	<body >
		<table width=100% >
			<tr>
				<td class="heading" colspan="2">TN Archive Data Search
				</td>
			</tr>
			<tr>
				<td class="menusection-Logs2" colspan=2>TN Archive Document Search&nbsp;</td>
			</tr>

<td class="evenrow-l"><a href="transactionAnalysis.dsp">Current Data Search</a> &nbsp;</td>
			...
			<form name="SearchForm" method="post" action="ViewArchiveDocs.dsp?search=true" target="main">
				...
				<input type="hidden" name="SortCriteria">
							...
							%endif Queries% 
								...
								<tr>
									<td class="evenrow">receive date</td>
									<td class="evenrow-l"><input name="FromDate"><a href="javascript:openCalendar('From Date');">start date</a>&nbsp;&nbsp;&nbsp;<input name="ToDate"><a href="javascript:openCalendar('To Date');">end date</a></td>
<!--
									<td class="evenrow-l"><input name="FromDate" onFocus="blur();"><a href="javascript:openCalendar('From Date');">start date</a></td>
								</tr>
								<tr>
									<td class="evenrow">&nbsp;</td>
									<td class="evenrow-l"><input name="ToDate" onFocus="blur();"><a href="javascript:openCalendar('To Date');">end date</a></td>
-->
								</tr>
								<tr>
							...
							<tr>
								...
								<td class="evenrow-l">
									<select name="SortBy"> 
										<option name="SortBy" selected value="DocTimestamp">date</option>
										<option name="SortBy" value="SenderID">sender</option>
										<option name="SortBy" value="DocTypeID">document type</option>
										<option name="SortBy" value="ReceiverID">receiver</option>
									</select>
								</td>
							</tr>
							<tr>
								<td class="evenrow">maximum result</td>
								<td class="evenrow-l"><input name="MaxReturned" size="5" value="100"></td>
							</tr>
							<tr>
<td colspan=2 class="action" align="center" width="100%"><input type="button" value="search" name="search" onclick="submitQuery();" target="main">

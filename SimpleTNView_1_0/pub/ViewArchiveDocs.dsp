<html>
	...
	<head>
		<title>TN archive search result</title>
	...
	<body >
		...
		<table width="100%" >
			<tr width="100%">
				<td class="menusection-Logs2" colspan=2>TN archive search result&nbsp;</td>
			</tr>
...
-->
			<tr>
				<td>
					<table width="100%">
					%ifvar Docs%
						<tr><td class="heading" colspan="7">Sent documents</td></tr>
						<tr>

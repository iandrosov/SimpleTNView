<html>
	...
	<head>
		...
		<script language="JavaScript1.2">
			...
			function readDate( whichEnd )
			{
				var d = null;
				if( whichEnd == "From Date" ) {
					d = opener.document.SearchForm.FromDate.value;
				} else {
					d = opener.document.SearchForm.ToDate.value;
				}
	...
	%invoke wm.tnweb.querySvc:getCalendar%
					...
					<form name="calForm" action="transactionAnalysis.dsp" mehtod="post">
						...
						<tr class="oddrow">
							<td colspan="7" align="center">
								&nbsp;&nbsp;%value /which% Selected <input type="text" name="dateSelected" size="19">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<html>
	...
	<body >
		...
		<table width="100%" >
			<tr width="100%">
				<td class="menusection-Logs2" colspan=2>TNアーカイブ検索結果&nbsp;</td>
			</tr>
			...
			<tr>
				<td>
					<table>
						...
						<!-- title bar -->
						<tr>
							<td class="heading" colspan=2>検索条件</td>
						</tr>
<!--
						<tr>
...
-->
						%ifvar FromDate%
						<tr>
							<td class="evenrow">開始日</td>
							<td class="evenrow-l">&nbsp;&nbsp;%value FromDate%</td>
						</tr>
						%endif%
						%ifvar ToDate%
						<tr>
							<td class="evenrow">終了日</td>
						...
						%ifvar SortBy%
						<tr>
							<td class="evenrow">検索結果の並べ替え基準</td>
		...
		%invoke SimpleTNView.svc:Ex_searchArchivePageSearch%
					<tr>
						<td class="evenrow">取得件数（最大）</td>
			...
			<tr>
				<td>
					...
					%ifvar Docs%
						...
						%loop Docs%
						<tr>
							<td class="evenrow-l"><a href="ViewArchiveDocDetail.dsp?docId=%value DocID%">%value DocTimestamp%</a> &nbsp;</td>

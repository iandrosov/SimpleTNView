...
<head>
	<title>TNアーカイブドキュメント 送受信データ内容（XML）</title>
...
-->
					<li><a href="ViewArchiveDocDetail.dsp?docId=%value docId%">アーカイブドキュメント詳細へ</a></li>
				</ul>
			</td>
		</tr>
...
-->
					<tr><td class="heading">%value partName%</td></tr>
					<tr>
						<td class="evencol">

<html>
	<head>
		...
		<title>Web Manager Configurations - User Detail</title>
		...
		<script language="JavaScript">
			...
			{
				//alert( "1. userNameToConfig = %value userNameToConfig%" );
			%ifvar profileSet%
				%invoke wm.tnweb.configFlow:setUserConfig%
					alert( "%value /userNameToConfig% configuration has been updated");
					%ifvar reloadMenu equals('true')%
			...
			%endif%
				...
				//alert( "2. userNameToConfig = %value userNameToConfig%" );
				...
				document.saveForm.userNameToConfig.value = "%value ../userNameToConfig%";
				document.saveForm.user.value = "%value ../userNameToConfig%";
				//alert( "after set userNameToConfig" );
				//alert( "userNameToConfig = " + document.saveForm.userNameToConfig.value );
			...
			<tr>
				<td valign="top">
					<ul>
						...
						<li><a href="config-users.dsp">Return to User Configuration</a></li>
					</ul>
				</td>
			</tr>
			...
			<tr>
				<td>
					<table width="100%">
						...
						<!-- table title -->
						<tr>
							<td class="heading" colspan=2>Customize configuration for specific user %value userNameToConfig% 
							</td>
						</tr>
						...
						<form name="saveForm" action="config-userDetail.dsp" method="post">
						<tr>
							<td colspan=2 class="action" align="center" width="100%">
								<input type="submit" onClick="submitUserConfig();"  value="Save Changes" name="save">
							</td>
							<!--- hidden inputs --->
							%invoke wm.tnweb.configFlow:getAllCaptions%
							%ifvar allCustomPages%

<html>
	...
	<head>
		<title>Archive Document Activities</title>
	...
	<table width="100%">
		<tr>
			<td class="menusection-Logs2" colspan=2>Analysis &gt; 
			Transactions &gt; 
			Document Details &gt;
			Activity Log&nbsp;</td>
		</tr>
...
-->
					<li><a href="ViewArchiveDocDetail.dsp?docId=%value internalId%">Return to Archive Document Details</a></li>
				</ul>
			</td>
		</tr>
		...
		<tr>
			<td>
				<table width="100%">
					<tr><td class="heading" colspan="5">Archive Document Activity Log</td></tr>
					<tr>

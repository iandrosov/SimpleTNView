...
<head>
	<title>Transaction Analysis Archive Document Contents</title>
	...
	%invoke SimpleTNView.archive:getDocContent%
	<script>
		function setNext()
		{
...
-->
					<li><a href="ViewArchiveDocDetail.dsp?docId=%value docId%">Return to Archive Document Details</a></li>
				</ul>
			</td>
		</tr>
